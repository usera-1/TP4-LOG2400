...
class AjouterFruitsCommand : public CommandeAbs {
public:
    AjouterFruitsCommand(std::vector<Yogourt*>& liste, int index, Yogourt* nouvelleGarniture, Stock& stock, const std::string& nom)
